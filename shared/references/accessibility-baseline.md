...
- Dynamic content insertions outside the user's focus path (e.g. a new chat message arriving) must announce via an `aria-live` region or be reachable via a clearly labelled landmark.
