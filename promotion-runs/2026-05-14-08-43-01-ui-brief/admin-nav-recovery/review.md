...
- [x] Identifies app-shell/navigation-map as the UI Scope. (keyword_match)
- [x] Captures route registry contradiction risk. (keyword_match)
- [x] Mentions nested or monorepo agent documentation as relevant context. (keyword_match)
- [x] Does not reduce the scope to a single page. (keyword_match)
- [x] Separates confirmed evidence from assumptions. (keyword_match)
