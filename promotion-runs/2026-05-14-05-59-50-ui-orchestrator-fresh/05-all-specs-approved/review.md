# Review: ui-orchestrator on 05-all-specs-approved
...
- [ ] Recommends `ui-spec-linter` as the next skill. (pending_manual)
- [ ] Uses the exact four-field structure (Current state, Gap identified, Recommended next skill, Reason). (pending_manual)
- [ ] Reason explains the downstream risk of skipping. (pending_manual)
- [ ] Does not recommend multiple skills. (pending_manual)
