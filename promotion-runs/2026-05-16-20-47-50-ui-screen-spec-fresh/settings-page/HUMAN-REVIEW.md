# HUMAN REVIEW: ui-screen-spec on settings-page

**Run ID:** 2026-05-16-20-47-50-ui-screen-spec-fresh
...
- Fixture depth verified: 24929 bytes across 4 files.
- Fixture family (clean/messy parity) verified.

### Rubric Evaluation
- [ ] All 5 component layouts must be mapped. (pending_manual)
- [ ] Data props must be defined. (pending_manual)
- [ ] Keyboard mapping must cover Tab and Enter keys. (pending_manual)
