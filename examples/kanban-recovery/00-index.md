...
- `input/`: normalized fixture inputs used to evaluate skills in this repository (stable, test-oriented representation). Includes `input/source-snippets/` with frozen code snapshots matching `fixture.yaml` `source_files`.
